...
public class Calculation  extends Numbers implements ActionListener
{
	...
	public void actionPerformed(ActionEvent evt){
		JButton kru = (JButton) evt.getSource();									//used for When a Button is pressed 
		
		if(kru.equals(plusButton)){
			if(tempString1 == null){
		...
		if(kru.equals(multiplicationButton)){
			if(tempString1 == null){
				System.out.println("Choose your numbers First!");
			}else
				if(tempString1 != null && tempString2 == null){
...
//git remote add origin https://github.com/Krishnawaman25/javaproject.git
//git branch -M main
